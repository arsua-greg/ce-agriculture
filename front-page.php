    ...
    <div class="banner">
        <div class="banner_container">
            <div class="banner__float">
                <p>糖度・香り高く<br />味わい深い</p>
                <p>東御の自然の恵をいっぱいに<br />浴びたぶどうをお届します</p>
            </div>
        </div>
        ...
        <div class="l-wrap">
         ...
         <div class="horizontal-container">
             ...
             <div class="column-item">
               <div class="column-img"><img src="<?php echo get_template_directory_uri();?>/release/image/section_4/東御という土地を選んだ理由.png" alt=""></div>
             ...
             <div class="column-item">
               <div class="column-img"><img src="<?php echo get_template_directory_uri();?>/release/image/section_4/R0003559.png" alt=""></div>
             ...
             <div class="column-item">
               <div class="column-img"><img src="<?php echo get_template_directory_uri();?>/release/image/section_4/R0003785.png" alt=""></div>
...
<!--  Second Element -->
     <div class="l-wrap">
         ...
         <div class="horizontal-container">
             ...
             <div class="column-item">
               <div class="column-img"><img src="<?php echo get_template_directory_uri();?>/release/image/section_4/PXL_20230723_010120440.png" alt=""></div>
             ...
             <div class="column-item">
               <div class="column-img"><img src="<?php echo get_template_directory_uri();?>/release/image/section_4/R0003591.png" alt=""></div>
             ...
             <div class="column-item">
               <div class="column-img"><img src="<?php echo get_template_directory_uri();?>/release/image/section_4/mud.png" alt=""></div>
